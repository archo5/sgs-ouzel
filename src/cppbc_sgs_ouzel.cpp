...
int sgsOuzelUIEvent::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	...
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "actor" ) ){ sgs_PushVar( callerCtx, getActor() ); return SGS_SUCCESS; }
		if( !strcmp( str, "touchId" ) ){ sgs_PushVar( callerCtx, touchId ); return SGS_SUCCESS; }
		if( !strcmp( str, "difference" ) ){ sgs_PushVar( callerCtx, difference ); return SGS_SUCCESS; }
		if( !strcmp( str, "differenceX" ) ){ sgs_PushVar( callerCtx, difference.x ); return SGS_SUCCESS; }
		if( !strcmp( str, "differenceY" ) ){ sgs_PushVar( callerCtx, difference.y ); return SGS_SUCCESS; }
...
int sgsOuzelUIEvent::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	...
	if( depth > 0 )
	{
		{ sgs_PushStringLit( callerCtx, "\nactor = " ); sgs_DumpData( callerCtx, getActor(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ntouchId = " ); sgs_DumpData( callerCtx, touchId, depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ndifference = " ); sgs_DumpData( callerCtx, difference, depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ndifferenceX = " ); sgs_DumpData( callerCtx, difference.x, depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ndifferenceY = " ); sgs_DumpData( callerCtx, difference.y, depth ).push( callerCtx ); }
...
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelCursor::_sgs_interface, (void**) &base, "sgsOuzelCursor.initFromFile" ) ) return 0;
	sgsOuzelCursor* data = static_cast<sgsOuzelCursor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->init( sgs_GetVar<std::string>()(callerCtx,0), sgs_GetVar<Vector2>()(callerCtx,1) )); return 1;
}

int sgsOuzelCursor::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelCursor::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelCursor::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelCursor::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelCursor::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelCursor::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelCursor::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelCursor::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelCursor::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelCursor::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelCursor::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelCursor::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelCursor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelCursor::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelCursor::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelCursor::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelCursor();
	return SGS_SUCCESS;
...
int sgsOuzelCursor::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	return SGS_SUCCESS;
}

int sgsOuzelCursor::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelCursor::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelCursor::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelCursor" );
	}
	return SGS_SUCCESS;
}

int sgsOuzelCursor::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 78 ];
	sprintf( bfr, "sgsOuzelCursor (obj=%p, base=%p) %s",
		static_cast< sgsOuzelCursor* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
...
int sgsUnserialize_sgsOuzelCursor( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelCursor, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelCursor[] =
{ { "sgsUnserialize_sgsOuzelCursor", sgsUnserialize_sgsOuzelCursor } };

static sgs_RegFuncConst sgsOuzelCursor__sgs_funcs[] =
{
	{ "initFromFile", _sgs_method__sgsOuzelCursor__initFromFile },
	{ NULL, NULL },
};

static int sgsOuzelCursor__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelCursor__sgs_funcs,
		-1, "sgsOuzelCursor." );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelCursor, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelCursor", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelCursor__sgs_interface =
{
	"sgsOuzelCursor",
	sgsOuzelCursor::_sgslocal_destruct, sgsOuzelCursor::_sgslocal_gcmark, sgsOuzelCursor::_sgslocal_getindex, sgsOuzelCursor::_sgslocal_setindex, NULL, sgsOuzelCursor::_sgslocal_serialize, sgsOuzelCursor::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
};
_sgsInterface sgsOuzelCursor::_sgs_interface(sgsOuzelCursor__sgs_interface, sgsOuzelCursor__sgs_ifn);


static int _sgs_method__sgsOuzelInput__setCursor( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.setCursor" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->setCursor( sgs_GetVar<sgsOuzelCursor::Handle>()(callerCtx,0) ); return 0;
}

static int _sgs_method__sgsOuzelInput__startGamepadDiscovery( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.startGamepadDiscovery" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->startGamepadDiscovery(  ); return 0;
}

static int _sgs_method__sgsOuzelInput__stopGamepadDiscovery( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.stopGamepadDiscovery" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->stopGamepadDiscovery(  ); return 0;
}

static int _sgs_method__sgsOuzelInput__isKeyboardKeyDown( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.isKeyboardKeyDown" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->isKeyboardKeyDown( sgs_GetVar<int>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelInput__isMouseButtonDown( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.isMouseButtonDown" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->isMouseButtonDown( sgs_GetVar<int>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelInput__showVirtualKeyboard( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.showVirtualKeyboard" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->showVirtualKeyboard(  )); return 1;
}

static int _sgs_method__sgsOuzelInput__hideVirtualKeyboard( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelInput::_sgs_interface, (void**) &base, "sgsOuzelInput.hideVirtualKeyboard" ) ) return 0;
	sgsOuzelInput* data = static_cast<sgsOuzelInput*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->hideVirtualKeyboard(  )); return 1;
}

int sgsOuzelInput::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelInput::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelInput::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelInput::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelInput::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelInput::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelInput::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelInput::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelInput::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelInput::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelInput::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelInput::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelInput*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelInput::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelInput::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelInput::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelInput();
	return SGS_SUCCESS;
...
int sgsOuzelInput::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	return SGS_SUCCESS;
}

int sgsOuzelInput::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "cursorVisible" ) ){ sgs_PushVar( callerCtx, sharedEngine->getInput()->isCursorVisible() ); return SGS_SUCCESS; }
		if( !strcmp( str, "cursorLocked" ) ){ sgs_PushVar( callerCtx, sharedEngine->getInput()->isCursorLocked() ); return SGS_SUCCESS; }
		if( !strcmp( str, "cursorPosition" ) ){ sgs_PushVar( callerCtx, sharedEngine->getInput()->getCursorPosition() ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelInput::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "cursorVisible" ) ){ sharedEngine->getInput()->setCursorVisible( sgs_GetVar<bool>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "cursorLocked" ) ){ sharedEngine->getInput()->setCursorLocked( sgs_GetVar<bool>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "cursorPosition" ) ){ sharedEngine->getInput()->setCursorPosition( sgs_GetVar<Vector2>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelInput::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelInput" );
	}
	sgs_InitStringLit( callerCtx, &key, "cursorVisible" );
	sgs_PushVar( callerCtx, sharedEngine->getInput()->isCursorVisible() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "cursorLocked" );
	sgs_PushVar( callerCtx, sharedEngine->getInput()->isCursorLocked() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "cursorPosition" );
	sgs_PushVar( callerCtx, sharedEngine->getInput()->getCursorPosition() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	return SGS_SUCCESS;
...
int sgsOuzelInput::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 77 ];
	sprintf( bfr, "sgsOuzelInput (obj=%p, base=%p) %s",
		static_cast< sgsOuzelInput* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
		{ sgs_PushStringLit( callerCtx, "\ncursorVisible = " ); sgs_DumpData( callerCtx, sharedEngine->getInput()->isCursorVisible(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ncursorLocked = " ); sgs_DumpData( callerCtx, sharedEngine->getInput()->isCursorLocked(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ncursorPosition = " ); sgs_DumpData( callerCtx, sharedEngine->getInput()->getCursorPosition(), depth ).push( callerCtx ); }
...
int sgsUnserialize_sgsOuzelInput( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelInput, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelInput[] =
{ { "sgsUnserialize_sgsOuzelInput", sgsUnserialize_sgsOuzelInput } };

static sgs_RegFuncConst sgsOuzelInput__sgs_funcs[] =
{
	{ "setCursor", _sgs_method__sgsOuzelInput__setCursor },
	{ "startGamepadDiscovery", _sgs_method__sgsOuzelInput__startGamepadDiscovery },
	{ "stopGamepadDiscovery", _sgs_method__sgsOuzelInput__stopGamepadDiscovery },
	{ "isKeyboardKeyDown", _sgs_method__sgsOuzelInput__isKeyboardKeyDown },
	{ "isMouseButtonDown", _sgs_method__sgsOuzelInput__isMouseButtonDown },
	{ "showVirtualKeyboard", _sgs_method__sgsOuzelInput__showVirtualKeyboard },
	{ "hideVirtualKeyboard", _sgs_method__sgsOuzelInput__hideVirtualKeyboard },
	{ NULL, NULL },
};

static int sgsOuzelInput__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelInput__sgs_funcs,
		-1, "sgsOuzelInput." );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelInput, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelInput", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelInput__sgs_interface =
{
	"sgsOuzelInput",
	sgsOuzelInput::_sgslocal_destruct, sgsOuzelInput::_sgslocal_gcmark, sgsOuzelInput::_sgslocal_getindex, sgsOuzelInput::_sgslocal_setindex, NULL, sgsOuzelInput::_sgslocal_serialize, sgsOuzelInput::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
};
_sgsInterface sgsOuzelInput::_sgs_interface(sgsOuzelInput__sgs_interface, sgsOuzelInput__sgs_ifn);
...
static int _sgs_method__sgsOuzelComponent__removeFromActor( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelComponent::_sgs_interface, (void**) &base, "sgsOuzelComponent.removeFromActor" ) ) return 0;
	sgsOuzelComponent* data = static_cast<sgsOuzelComponent*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->removeFromActor(  ); return 0;
}
...
static sgs_RegFuncConst sgsOuzelComponent__sgs_funcs[] =
{
	...
	{ "removeFromActor", _sgs_method__sgsOuzelComponent__removeFromActor },
	{ NULL, NULL },
};
...
static int _sgs_method__sgsOuzelShapeRenderer__polygon( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelShapeRenderer::_sgs_interface, (void**) &base, "sgsOuzelShapeRenderer.polygon" ) ) return 0;
	sgsOuzelShapeRenderer* data = static_cast<sgsOuzelShapeRenderer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->polygon( sgs_GetVar<std::vector<Vector2> >()(callerCtx,0), sgs_GetVar<Color>()(callerCtx,1), sgs_GetVar<bool>()(callerCtx,2), sgs_GetVar<float>()(callerCtx,3) )); return 1;
}

static int _sgs_method__sgsOuzelShapeRenderer__curve( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelShapeRenderer::_sgs_interface, (void**) &base, "sgsOuzelShapeRenderer.curve" ) ) return 0;
	sgsOuzelShapeRenderer* data = static_cast<sgsOuzelShapeRenderer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->curve( sgs_GetVar<std::vector<Vector2> >()(callerCtx,0), sgs_GetVar<Color>()(callerCtx,1), sgs_GetVar<uint32_t>()(callerCtx,2), sgs_GetVar<float>()(callerCtx,3) )); return 1;
}
...
static sgs_RegFuncConst sgsOuzelShapeRenderer__sgs_funcs[] =
{
	...
	{ "polygon", _sgs_method__sgsOuzelShapeRenderer__polygon },
	{ "curve", _sgs_method__sgsOuzelShapeRenderer__curve },
	{ NULL, NULL },
};
...
static int _sgs_method__sgsOuzelParticleSystem__initFromFile( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelParticleSystem::_sgs_interface, (void**) &base, "sgsOuzelParticleSystem.initFromFile" ) ) return 0;
	sgsOuzelParticleSystem* data = static_cast<sgsOuzelParticleSystem*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->initFromFile( sgs_GetVar<string>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelParticleSystem__resume( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelParticleSystem::_sgs_interface, (void**) &base, "sgsOuzelParticleSystem.resume" ) ) return 0;
	sgsOuzelParticleSystem* data = static_cast<sgsOuzelParticleSystem*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->resume(  ); return 0;
}

static int _sgs_method__sgsOuzelParticleSystem__stop( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelParticleSystem::_sgs_interface, (void**) &base, "sgsOuzelParticleSystem.stop" ) ) return 0;
	sgsOuzelParticleSystem* data = static_cast<sgsOuzelParticleSystem*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->stop(  ); return 0;
}

static int _sgs_method__sgsOuzelParticleSystem__reset( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelParticleSystem::_sgs_interface, (void**) &base, "sgsOuzelParticleSystem.reset" ) ) return 0;
	sgsOuzelParticleSystem* data = static_cast<sgsOuzelParticleSystem*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->reset(  ); return 0;
}

int sgsOuzelParticleSystem::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelParticleSystem::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelParticleSystem::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelParticleSystem*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelParticleSystem::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelParticleSystem::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelParticleSystem::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelParticleSystem();
	return SGS_SUCCESS;
}

int sgsOuzelParticleSystem::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	sgsOuzelComponent::_sgs_gcmark( callerCtx, obj );
	return SGS_SUCCESS;
...
int sgsOuzelParticleSystem::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		...
		if( !strcmp( str, "active" ) ){ sgs_PushVar( callerCtx, Item()->isActive() ); return SGS_SUCCESS; }
	}
	return sgsOuzelComponent::_sgs_getindex( callerCtx, obj );
}

int sgsOuzelParticleSystem::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelParticleSystem::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelParticleSystem" );
	}
	sgsOuzelComponent::_sgsimpl_serialize( C, obj );
	return SGS_SUCCESS;
}

int sgsOuzelParticleSystem::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 86 ];
	sprintf( bfr, "sgsOuzelParticleSystem (obj=%p, base=%p) %s",
		static_cast< sgsOuzelParticleSystem* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
		...
		{ sgs_PushStringLit( callerCtx, "\nactive = " ); sgs_DumpData( callerCtx, Item()->isActive(), depth ).push( callerCtx ); }
		sgs_StringConcat( callerCtx, 6 );
		sgs_PadString( callerCtx );
		sgs_PushStringLit( callerCtx, "\n}" );
		sgs_StringConcat( callerCtx, 3 );
...
int sgsUnserialize_sgsOuzelParticleSystem( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelParticleSystem, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelParticleSystem[] =
{ { "sgsUnserialize_sgsOuzelParticleSystem", sgsUnserialize_sgsOuzelParticleSystem } };

static sgs_RegFuncConst sgsOuzelParticleSystem__sgs_funcs[] =
{
	{ "initFromFile", _sgs_method__sgsOuzelParticleSystem__initFromFile },
	{ "resume", _sgs_method__sgsOuzelParticleSystem__resume },
	{ "stop", _sgs_method__sgsOuzelParticleSystem__stop },
	{ "reset", _sgs_method__sgsOuzelParticleSystem__reset },
	{ NULL, NULL },
};

static int sgsOuzelParticleSystem__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelParticleSystem__sgs_funcs,
		-1, "sgsOuzelParticleSystem." );
	sgsVariable mo = sgs_GetClassInterface< sgsOuzelComponent >( C );
	sgs_ObjSetMetaObj( C, sgs_GetObjectStruct( C, -1 ), mo.get_object_struct() );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelParticleSystem, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelParticleSystem", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelParticleSystem__sgs_interface =
{
	"sgsOuzelParticleSystem",
	sgsOuzelParticleSystem::_sgslocal_destruct, sgsOuzelParticleSystem::_sgslocal_gcmark, sgsOuzelParticleSystem::_sgslocal_getindex, sgsOuzelParticleSystem::_sgslocal_setindex, NULL, sgsOuzelParticleSystem::_sgslocal_serialize, sgsOuzelParticleSystem::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
	sgsOuzelComponent::_sgs_interface,
};
_sgsInterface sgsOuzelParticleSystem::_sgs_interface(sgsOuzelParticleSystem__sgs_interface, sgsOuzelParticleSystem__sgs_ifn);
...
int sgsOuzelAnimator::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	...
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		...
		if( !strcmp( str, "targetActor" ) ){ sgs_PushVar( callerCtx, getTargetActor() ); return SGS_SUCCESS; }
...
int sgsOuzelAnimator::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	...
	if( depth > 0 )
	{
		...
		{ sgs_PushStringLit( callerCtx, "\ntargetActor = " ); sgs_DumpData( callerCtx, getTargetActor(), depth ).push( callerCtx ); }
...
static int _sgs_method__sgsOuzelListener__add( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelListener::_sgs_interface, (void**) &base, "sgsOuzelListener.add" ) ) return 0;
	sgsOuzelListener* data = static_cast<sgsOuzelListener*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->add(  ); return 0;
}

static int _sgs_method__sgsOuzelListener__remove( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelListener::_sgs_interface, (void**) &base, "sgsOuzelListener.remove" ) ) return 0;
	sgsOuzelListener* data = static_cast<sgsOuzelListener*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->remove(  ); return 0;
}

int sgsOuzelListener::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelListener::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelListener::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelListener::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelListener::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelListener::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelListener::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelListener::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelListener::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelListener::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelListener::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelListener::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelListener*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelListener::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelListener::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelListener::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelListener();
	return SGS_SUCCESS;
}

int sgsOuzelListener::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	sgsOuzelComponent::_sgs_gcmark( callerCtx, obj );
	return SGS_SUCCESS;
...
int sgsOuzelListener::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelListener::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelListener::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelListener" );
	}
...
int sgsOuzelListener::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 80 ];
	sprintf( bfr, "sgsOuzelListener (obj=%p, base=%p) %s",
		static_cast< sgsOuzelListener* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
...
int sgsUnserialize_sgsOuzelListener( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelListener, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelListener[] =
{ { "sgsUnserialize_sgsOuzelListener", sgsUnserialize_sgsOuzelListener } };

static sgs_RegFuncConst sgsOuzelListener__sgs_funcs[] =
{
	{ "add", _sgs_method__sgsOuzelListener__add },
	{ "remove", _sgs_method__sgsOuzelListener__remove },
	{ NULL, NULL },
};

static int sgsOuzelListener__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelListener__sgs_funcs,
		-1, "sgsOuzelListener." );
	sgsVariable mo = sgs_GetClassInterface< sgsOuzelComponent >( C );
	sgs_ObjSetMetaObj( C, sgs_GetObjectStruct( C, -1 ), mo.get_object_struct() );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelListener, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelListener", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelListener__sgs_interface =
{
	"sgsOuzelListener",
	sgsOuzelListener::_sgslocal_destruct, sgsOuzelListener::_sgslocal_gcmark, sgsOuzelListener::_sgslocal_getindex, sgsOuzelListener::_sgslocal_setindex, NULL, sgsOuzelListener::_sgslocal_serialize, sgsOuzelListener::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
	sgsOuzelComponent::_sgs_interface,
};
_sgsInterface sgsOuzelListener::_sgs_interface(sgsOuzelListener__sgs_interface, sgsOuzelListener__sgs_ifn);


static int _sgs_method__sgsOuzelActorContainer__addChild( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.addChild" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->addChild( sgs_GetVar<sgsHandle< struct sgsOuzelActor > >()(callerCtx,0) ); return 0;
}

static int _sgs_method__sgsOuzelActorContainer__removeChild( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.removeChild" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->removeChild( sgs_GetVar<sgsHandle< struct sgsOuzelActor > >()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelActorContainer__moveChildToBack( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.moveChildToBack" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->moveChildToBack( sgs_GetVar<sgsHandle< struct sgsOuzelActor > >()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelActorContainer__moveChildToFront( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.moveChildToFront" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->moveChildToFront( sgs_GetVar<sgsHandle< struct sgsOuzelActor > >()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelActorContainer__removeAllChildren( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.removeAllChildren" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->removeAllChildren(  ); return 0;
}

static int _sgs_method__sgsOuzelActorContainer__hasChild( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.hasChild" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->hasChild( sgs_GetVar<sgsHandle< struct sgsOuzelActor > >()(callerCtx,0), sgs_GetVar<bool>()(callerCtx,1) )); return 1;
}

static int _sgs_method__sgsOuzelActorContainer__getChildren( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.getChildren" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->getChildren(  )); return 1;
}

static int _sgs_method__sgsOuzelActorContainer__getLayer( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActorContainer::_sgs_interface, (void**) &base, "sgsOuzelActorContainer.getLayer" ) ) return 0;
	sgsOuzelActorContainer* data = static_cast<sgsOuzelActorContainer*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->getLayer(  )); return 1;
}

int sgsOuzelActorContainer::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelActorContainer::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelActorContainer::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelActorContainer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelActorContainer::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActorContainer::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelActorContainer::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelActorContainer();
	return SGS_SUCCESS;
}

int sgsOuzelActorContainer::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	return SGS_SUCCESS;
}

int sgsOuzelActorContainer::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelActorContainer::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
...
int sgsOuzelActorContainer::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelActorContainer" );
	}
	return SGS_SUCCESS;
}

int sgsOuzelActorContainer::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 86 ];
	sprintf( bfr, "sgsOuzelActorContainer (obj=%p, base=%p) %s",
		static_cast< sgsOuzelActorContainer* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
...
int sgsUnserialize_sgsOuzelActorContainer( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelActorContainer, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelActorContainer[] =
{ { "sgsUnserialize_sgsOuzelActorContainer", sgsUnserialize_sgsOuzelActorContainer } };

static sgs_RegFuncConst sgsOuzelActorContainer__sgs_funcs[] =
{
	{ "addChild", _sgs_method__sgsOuzelActorContainer__addChild },
	{ "removeChild", _sgs_method__sgsOuzelActorContainer__removeChild },
	{ "moveChildToBack", _sgs_method__sgsOuzelActorContainer__moveChildToBack },
	{ "moveChildToFront", _sgs_method__sgsOuzelActorContainer__moveChildToFront },
	{ "removeAllChildren", _sgs_method__sgsOuzelActorContainer__removeAllChildren },
	{ "hasChild", _sgs_method__sgsOuzelActorContainer__hasChild },
	{ "getChildren", _sgs_method__sgsOuzelActorContainer__getChildren },
	{ "getLayer", _sgs_method__sgsOuzelActorContainer__getLayer },
	{ NULL, NULL },
};

static int sgsOuzelActorContainer__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelActorContainer__sgs_funcs,
		-1, "sgsOuzelActorContainer." );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelActorContainer, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelActorContainer", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelActorContainer__sgs_interface =
{
	"sgsOuzelActorContainer",
	sgsOuzelActorContainer::_sgslocal_destruct, sgsOuzelActorContainer::_sgslocal_gcmark, sgsOuzelActorContainer::_sgslocal_getindex, sgsOuzelActorContainer::_sgslocal_setindex, NULL, sgsOuzelActorContainer::_sgslocal_serialize, sgsOuzelActorContainer::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
};
_sgsInterface sgsOuzelActorContainer::_sgs_interface(sgsOuzelActorContainer__sgs_interface, sgsOuzelActorContainer__sgs_ifn);


static int _sgs_method__sgsOuzelActor__pointOn( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.pointOn" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->pointOn( sgs_GetVar<Vector2>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelActor__removeFromParent( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.removeFromParent" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->removeFromParent(  ); return 0;
}

static int _sgs_method__sgsOuzelActor__addComponent( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.addComponent" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->addComponent( sgs_GetVar<sgsOuzelComponent::Handle>()(callerCtx,0) ); return 0;
}

static int _sgs_method__sgsOuzelActor__removeComponent( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.removeComponent" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->removeComponent( sgs_GetVar<sgsOuzelComponent::Handle>()(callerCtx,0) ); return 0;
}

static int _sgs_method__sgsOuzelActor__removeAllComponents( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.removeAllComponents" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->removeAllComponents(  ); return 0;
}

static int _sgs_method__sgsOuzelActor__getComponents( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelActor::_sgs_interface, (void**) &base, "sgsOuzelActor.getComponents" ) ) return 0;
	sgsOuzelActor* data = static_cast<sgsOuzelActor*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->getComponents( sgs_GetVar<uint32_t>()(callerCtx,0) )); return 1;
}

int sgsOuzelActor::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelActor::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelActor::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelActor::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelActor::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelActor::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelActor::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelActor::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelActor::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelActor::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelActor::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelActor::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelActor*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelActor::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelActor::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelActor::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelActor();
	return SGS_SUCCESS;
...
int sgsOuzelActor::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	sgsOuzelActorContainer::_sgs_gcmark( callerCtx, obj );
	return SGS_SUCCESS;
}

int sgsOuzelActor::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	...
	return sgsOuzelActorContainer::_sgs_getindex( callerCtx, obj );
}

int sgsOuzelActor::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	...
	return sgsOuzelActorContainer::_sgs_setindex( callerCtx, obj );
}

int sgsOuzelActor::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelActor" );
	}
	sgs_InitStringLit( callerCtx, &key, "position" );
	sgs_PushVar( callerCtx, Item()->getPosition() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	...
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgsOuzelActorContainer::_sgsimpl_serialize( C, obj );
	return SGS_SUCCESS;
}

int sgsOuzelActor::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 77 ];
	sprintf( bfr, "sgsOuzelActor (obj=%p, base=%p) %s",
		static_cast< sgsOuzelActor* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
		sgs_PushStringLit( callerCtx, "\n[inherited] " );
		sgsOuzelActorContainer::_sgs_dump( callerCtx, obj, depth );
		{ sgs_PushStringLit( callerCtx, "\nposition = " ); sgs_DumpData( callerCtx, Item()->getPosition(), depth ).push( callerCtx ); }
...
int sgsUnserialize_sgsOuzelActor( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelActor, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelActor[] =
{ { "sgsUnserialize_sgsOuzelActor", sgsUnserialize_sgsOuzelActor } };

static sgs_RegFuncConst sgsOuzelActor__sgs_funcs[] =
{
	{ "pointOn", _sgs_method__sgsOuzelActor__pointOn },
	{ "removeFromParent", _sgs_method__sgsOuzelActor__removeFromParent },
	{ "addComponent", _sgs_method__sgsOuzelActor__addComponent },
	{ "removeComponent", _sgs_method__sgsOuzelActor__removeComponent },
	{ "removeAllComponents", _sgs_method__sgsOuzelActor__removeAllComponents },
	{ "getComponents", _sgs_method__sgsOuzelActor__getComponents },
	{ NULL, NULL },
};

static int sgsOuzelActor__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelActor__sgs_funcs,
		-1, "sgsOuzelActor." );
	sgsVariable mo = sgs_GetClassInterface< sgsOuzelActorContainer >( C );
	sgs_ObjSetMetaObj( C, sgs_GetObjectStruct( C, -1 ), mo.get_object_struct() );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelActor, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelActor", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelActor__sgs_interface =
{
	"sgsOuzelActor",
	sgsOuzelActor::_sgslocal_destruct, sgsOuzelActor::_sgslocal_gcmark, sgsOuzelActor::_sgslocal_getindex, sgsOuzelActor::_sgslocal_setindex, NULL, sgsOuzelActor::_sgslocal_serialize, sgsOuzelActor::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
	sgsOuzelActorContainer::_sgs_interface,
};
_sgsInterface sgsOuzelActor::_sgs_interface(sgsOuzelActor__sgs_interface, sgsOuzelActor__sgs_ifn);
...
static int _sgs_method__sgsOuzelCamera__recalculateProjection( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelCamera::_sgs_interface, (void**) &base, "sgsOuzelCamera.recalculateProjection" ) ) return 0;
	sgsOuzelCamera* data = static_cast<sgsOuzelCamera*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->recalculateProjection(  ); return 0;
}

static int _sgs_method__sgsOuzelCamera__convertNormalizedToWorld( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelCamera::_sgs_interface, (void**) &base, "sgsOuzelCamera.convertNormalizedToWorld" ) ) return 0;
	sgsOuzelCamera* data = static_cast<sgsOuzelCamera*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->convertNormalizedToWorld( sgs_GetVar<Vector2>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelCamera__convertWorldToNormalized( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelCamera::_sgs_interface, (void**) &base, "sgsOuzelCamera.convertWorldToNormalized" ) ) return 0;
	sgsOuzelCamera* data = static_cast<sgsOuzelCamera*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->convertWorldToNormalized( sgs_GetVar<Vector3>()(callerCtx,0) )); return 1;
}
...
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	sgsOuzelActor::_sgs_gcmark( callerCtx, obj );
	return SGS_SUCCESS;
}
...
int sgsOuzelCamera::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	...
	return sgsOuzelActor::_sgs_getindex( callerCtx, obj );
}
...
int sgsOuzelCamera::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	...
	return sgsOuzelActor::_sgs_setindex( callerCtx, obj );
}
...
int sgsOuzelCamera::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	...
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgsOuzelActor::_sgsimpl_serialize( C, obj );
	return SGS_SUCCESS;
}
...
int sgsOuzelCamera::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	...
	{
		sgs_PushStringLit( callerCtx, "\n[inherited] " );
		sgsOuzelActor::_sgs_dump( callerCtx, obj, depth );
...
{
	{ "recalculateProjection", _sgs_method__sgsOuzelCamera__recalculateProjection },
	{ "convertNormalizedToWorld", _sgs_method__sgsOuzelCamera__convertNormalizedToWorld },
	{ "convertWorldToNormalized", _sgs_method__sgsOuzelCamera__convertWorldToNormalized },
	{ NULL, NULL },
};
...
static int sgsOuzelCamera__sgs_ifn( SGS_CTX )
{
	...
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		...
		-1, "sgsOuzelCamera." );
	sgsVariable mo = sgs_GetClassInterface< sgsOuzelActor >( C );
	sgs_ObjSetMetaObj( C, sgs_GetObjectStruct( C, -1 ), mo.get_object_struct() );
...
static int _sgs_method__sgsOuzelSound__initFromFile( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelSound::_sgs_interface, (void**) &base, "sgsOuzelSound.initFromFile" ) ) return 0;
	sgsOuzelSound* data = static_cast<sgsOuzelSound*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	sgs_PushVar(callerCtx,data->initFromFile( sgs_GetVar<string>()(callerCtx,0) )); return 1;
}

static int _sgs_method__sgsOuzelSound__play( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelSound::_sgs_interface, (void**) &base, "sgsOuzelSound.play" ) ) return 0;
	sgsOuzelSound* data = static_cast<sgsOuzelSound*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->play( sgs_GetVar<bool>()(callerCtx,0) ); return 0;
}

static int _sgs_method__sgsOuzelSound__pause( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelSound::_sgs_interface, (void**) &base, "sgsOuzelSound.pause" ) ) return 0;
	sgsOuzelSound* data = static_cast<sgsOuzelSound*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->pause(  ); return 0;
}

static int _sgs_method__sgsOuzelSound__stop( sgs_Context* callerCtx )
{
	sgsLiteObjectBase* base;
	if( !sgs_ParseMethodInh( callerCtx, sgsOuzelSound::_sgs_interface, (void**) &base, "sgsOuzelSound.stop" ) ) return 0;
	sgsOuzelSound* data = static_cast<sgsOuzelSound*>( base );
	_sgsTmpChanger<sgs_Context*> _tmpchg( data->C, callerCtx );
	data->stop(  ); return 0;
}

int sgsOuzelSound::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelSound::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelSound::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelSound::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelSound::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelSound::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelSound::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelSound::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelSound::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelSound::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelSound::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelSound::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelSound*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelSound::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelSound::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelSound::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelSound();
	return SGS_SUCCESS;
...
int sgsOuzelSound::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	return SGS_SUCCESS;
}

int sgsOuzelSound::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "position" ) ){ sgs_PushVar( callerCtx, getPosition() ); return SGS_SUCCESS; }
		if( !strcmp( str, "pitch" ) ){ sgs_PushVar( callerCtx, getPitch() ); return SGS_SUCCESS; }
		if( !strcmp( str, "gain" ) ){ sgs_PushVar( callerCtx, getGain() ); return SGS_SUCCESS; }
		if( !strcmp( str, "rolloffFactor" ) ){ sgs_PushVar( callerCtx, getRolloffFactor() ); return SGS_SUCCESS; }
		if( !strcmp( str, "minDistance" ) ){ sgs_PushVar( callerCtx, getMinDistance() ); return SGS_SUCCESS; }
		if( !strcmp( str, "maxDistance" ) ){ sgs_PushVar( callerCtx, getMaxDistance() ); return SGS_SUCCESS; }
		if( !strcmp( str, "output" ) ){ sgs_PushVar( callerCtx, sgsGetOutput() ); return SGS_SUCCESS; }
		if( !strcmp( str, "playing" ) ){ sgs_PushVar( callerCtx, isPlaying() ); return SGS_SUCCESS; }
		if( !strcmp( str, "repeating" ) ){ sgs_PushVar( callerCtx, isRepeating() ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelSound::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "position" ) ){ setPosition( sgs_GetVar<Vector3>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "pitch" ) ){ setPitch( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "gain" ) ){ setGain( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "rolloffFactor" ) ){ setRolloffFactor( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "minDistance" ) ){ setMinDistance( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "maxDistance" ) ){ setMaxDistance( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "output" ) ){ sgsSetOutput( sgs_GetVar<sgsVariable>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelSound::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelSound" );
	}
	sgs_InitStringLit( callerCtx, &key, "position" );
	sgs_PushVar( callerCtx, getPosition() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "pitch" );
	sgs_PushVar( callerCtx, getPitch() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "gain" );
	sgs_PushVar( callerCtx, getGain() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "rolloffFactor" );
	sgs_PushVar( callerCtx, getRolloffFactor() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "minDistance" );
	sgs_PushVar( callerCtx, getMinDistance() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "maxDistance" );
	sgs_PushVar( callerCtx, getMaxDistance() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "output" );
	sgs_PushVar( callerCtx, sgsGetOutput() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	return SGS_SUCCESS;
...
int sgsOuzelSound::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 77 ];
	sprintf( bfr, "sgsOuzelSound (obj=%p, base=%p) %s",
		static_cast< sgsOuzelSound* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
		{ sgs_PushStringLit( callerCtx, "\nposition = " ); sgs_DumpData( callerCtx, getPosition(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\npitch = " ); sgs_DumpData( callerCtx, getPitch(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ngain = " ); sgs_DumpData( callerCtx, getGain(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nrolloffFactor = " ); sgs_DumpData( callerCtx, getRolloffFactor(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nminDistance = " ); sgs_DumpData( callerCtx, getMinDistance(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nmaxDistance = " ); sgs_DumpData( callerCtx, getMaxDistance(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\noutput = " ); sgs_DumpData( callerCtx, sgsGetOutput(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nplaying = " ); sgs_DumpData( callerCtx, isPlaying(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nrepeating = " ); sgs_DumpData( callerCtx, isRepeating(), depth ).push( callerCtx ); }
		sgs_StringConcat( callerCtx, 18 );
		sgs_PadString( callerCtx );
		sgs_PushStringLit( callerCtx, "\n}" );
		sgs_StringConcat( callerCtx, 3 );
...
int sgsUnserialize_sgsOuzelSound( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelSound, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelSound[] =
{ { "sgsUnserialize_sgsOuzelSound", sgsUnserialize_sgsOuzelSound } };

static sgs_RegFuncConst sgsOuzelSound__sgs_funcs[] =
{
	{ "initFromFile", _sgs_method__sgsOuzelSound__initFromFile },
	{ "play", _sgs_method__sgsOuzelSound__play },
	{ "pause", _sgs_method__sgsOuzelSound__pause },
	{ "stop", _sgs_method__sgsOuzelSound__stop },
	{ NULL, NULL },
};

static int sgsOuzelSound__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelSound__sgs_funcs,
		-1, "sgsOuzelSound." );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelSound, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelSound", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelSound__sgs_interface =
{
	"sgsOuzelSound",
	sgsOuzelSound::_sgslocal_destruct, sgsOuzelSound::_sgslocal_gcmark, sgsOuzelSound::_sgslocal_getindex, sgsOuzelSound::_sgslocal_setindex, NULL, sgsOuzelSound::_sgslocal_serialize, sgsOuzelSound::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
};
_sgsInterface sgsOuzelSound::_sgs_interface(sgsOuzelSound__sgs_interface, sgsOuzelSound__sgs_ifn);


int sgsOuzelMixer::_sgs_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelMixer::_sgslocal_destruct( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_destruct( callerCtx, obj ); }
int sgsOuzelMixer::_sgs_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelMixer::_sgslocal_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_gcmark( callerCtx, obj ); }
int sgsOuzelMixer::_sgs_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelMixer::_sgslocal_getindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_getindex( callerCtx, obj ); }
int sgsOuzelMixer::_sgs_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelMixer::_sgslocal_setindex( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_setindex( callerCtx, obj ); }
int sgsOuzelMixer::_sgs_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgslocal_convert( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgs_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return _sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelMixer::_sgslocal_serialize( sgs_Context* callerCtx, sgs_VarObj* obj ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_serialize( callerCtx, obj ); }
int sgsOuzelMixer::_sgs_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return _sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelMixer::_sgslocal_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return static_cast<sgsOuzelMixer*>( static_cast<sgsLiteObjectBase*>( obj->data ) )->_sgsimpl_dump( callerCtx, obj, param ); }
int sgsOuzelMixer::_sgs_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgslocal_getnext( sgs_Context* callerCtx, sgs_VarObj* obj, int param ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgs_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgslocal_call( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgs_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }
int sgsOuzelMixer::_sgslocal_expr( sgs_Context* callerCtx, sgs_VarObj* obj ){ return SGS_ENOTSUP; }

int sgsOuzelMixer::_sgsimpl_destruct( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	C = callerCtx;
	this->~sgsOuzelMixer();
	return SGS_SUCCESS;
...
int sgsOuzelMixer::_sgsimpl_gcmark( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	return SGS_SUCCESS;
}

int sgsOuzelMixer::_sgsimpl_getindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "pitch" ) ){ sgs_PushVar( callerCtx, getPitch() ); return SGS_SUCCESS; }
		if( !strcmp( str, "gain" ) ){ sgs_PushVar( callerCtx, getGain() ); return SGS_SUCCESS; }
		if( !strcmp( str, "rolloffScale" ) ){ sgs_PushVar( callerCtx, getRolloffScale() ); return SGS_SUCCESS; }
		if( !strcmp( str, "output" ) ){ sgs_PushVar( callerCtx, sgsGetOutput() ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelMixer::_sgsimpl_setindex( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char* str;
	if( sgs_ParseString( callerCtx, 0, &str, NULL ) )
	{
		if( !strcmp( str, "pitch" ) ){ setPitch( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "gain" ) ){ setGain( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "rolloffScale" ) ){ setRolloffScale( sgs_GetVar<float>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
		if( !strcmp( str, "output" ) ){ sgsSetOutput( sgs_GetVar<sgsVariable>()( callerCtx, 1 ) ); return SGS_SUCCESS; }
	}
	return SGS_ENOTFND;
}

int sgsOuzelMixer::_sgsimpl_serialize( sgs_Context* callerCtx, sgs_VarObj* obj )
{
	sgs_Variable key;
	(void) key;
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	if( obj->iface == _sgs_interface )
	{
		sgs_SerializeObject( callerCtx, 0, "sgsUnserialize_sgsOuzelMixer" );
	}
	sgs_InitStringLit( callerCtx, &key, "pitch" );
	sgs_PushVar( callerCtx, getPitch() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	...
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "rolloffScale" );
	sgs_PushVar( callerCtx, getRolloffScale() );
	sgs_SerializeObjIndex( callerCtx, key, sgs_StackItem( callerCtx, -1 ), 1 );
	sgs_Pop( callerCtx, 1 );
	sgs_Release( callerCtx, &key );
	sgs_InitStringLit( callerCtx, &key, "output" );
...
int sgsOuzelMixer::_sgsimpl_dump( sgs_Context* callerCtx, sgs_VarObj* obj, int depth )
{
	_sgsTmpChanger<sgs_Context*> _tmpchg( C, callerCtx );
	char bfr[ 77 ];
	sprintf( bfr, "sgsOuzelMixer (obj=%p, base=%p) %s",
		static_cast< sgsOuzelMixer* >( static_cast<sgsLiteObjectBase*>( obj->data ) ),
		obj->data, depth > 0 ? "\n{" : " ..." );
	sgs_PushString( callerCtx, bfr );
	if( depth > 0 )
	{
		{ sgs_PushStringLit( callerCtx, "\npitch = " ); sgs_DumpData( callerCtx, getPitch(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\ngain = " ); sgs_DumpData( callerCtx, getGain(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\nrolloffScale = " ); sgs_DumpData( callerCtx, getRolloffScale(), depth ).push( callerCtx ); }
		{ sgs_PushStringLit( callerCtx, "\noutput = " ); sgs_DumpData( callerCtx, sgsGetOutput(), depth ).push( callerCtx ); }
		sgs_StringConcat( callerCtx, 8 );
		sgs_PadString( callerCtx );
		sgs_PushStringLit( callerCtx, "\n}" );
...
int sgsUnserialize_sgsOuzelMixer( SGS_CTX )
{
	SGS_CREATECLASS( C, NULL, sgsOuzelMixer, (  ) );
	return 1;
}
static sgs_RegFuncConst sgsUnserializeRFC_sgsOuzelMixer[] =
{ { "sgsUnserialize_sgsOuzelMixer", sgsUnserialize_sgsOuzelMixer } };

static sgs_RegFuncConst sgsOuzelMixer__sgs_funcs[] =
{
	{ NULL, NULL },
};

static int sgsOuzelMixer__sgs_ifn( SGS_CTX )
{
	sgs_CreateDict( C, NULL, 0 );
	sgs_StoreFuncConsts( C, sgs_StackItem( C, -1 ),
		sgsOuzelMixer__sgs_funcs,
		-1, "sgsOuzelMixer." );
	sgs_RegFuncConsts( C, sgsUnserializeRFC_sgsOuzelMixer, 1 );
	sgs_RegSymbol( C, "", "sgsOuzelMixer", sgs_StackItem( C, -1 ) );
	return 1;
}

static sgs_ObjInterface sgsOuzelMixer__sgs_interface =
{
	"sgsOuzelMixer",
	sgsOuzelMixer::_sgslocal_destruct, sgsOuzelMixer::_sgslocal_gcmark, sgsOuzelMixer::_sgslocal_getindex, sgsOuzelMixer::_sgslocal_setindex, NULL, sgsOuzelMixer::_sgslocal_serialize, sgsOuzelMixer::_sgslocal_dump, NULL, NULL, NULL, 
	NULL,
};
_sgsInterface sgsOuzelMixer::_sgs_interface(sgsOuzelMixer__sgs_interface, sgsOuzelMixer__sgs_ifn);
...
static int _sgs_method__sgsOuzel__createCursor( sgs_Context* callerCtx )
{
	...
	sgs_PushVar(callerCtx,sgsOuzel::createCursor(  )); return 1;
}
...
static int _sgs_method__sgsOuzel__createParticleSystem( sgs_Context* callerCtx )
{
	sgs_FuncName( callerCtx, "sgsOuzel.createParticleSystem" );
	sgs_PushVar(callerCtx,sgsOuzel::createParticleSystem( sgs_GetVar<string>()(callerCtx,0) )); return 1;
}
...
static int _sgs_method__sgsOuzel__createListener( sgs_Context* callerCtx )
{
	sgs_FuncName( callerCtx, "sgsOuzel.createListener" );
	sgs_PushVar(callerCtx,sgsOuzel::createListener(  )); return 1;
}
...
static int _sgs_method__sgsOuzel__createActor( sgs_Context* callerCtx )
{
	sgs_FuncName( callerCtx, "sgsOuzel.createActor" );
	sgs_PushVar(callerCtx,sgsOuzel::createActor(  )); return 1;
}
...
static int _sgs_method__sgsOuzel__createSound( sgs_Context* callerCtx )
{
	sgs_FuncName( callerCtx, "sgsOuzel.createSound" );
	sgs_PushVar(callerCtx,sgsOuzel::createSound(  )); return 1;
}

static int _sgs_method__sgsOuzel__createMixer( sgs_Context* callerCtx )
{
	sgs_FuncName( callerCtx, "sgsOuzel.createMixer" );
	sgs_PushVar(callerCtx,sgsOuzel::createMixer(  )); return 1;
}
...
static sgs_RegFuncConst sgsOuzel__sgs_funcs[] =
{
	...
	{ "createParticleSystem", _sgs_method__sgsOuzel__createParticleSystem },
	...
	{ "createListener", _sgs_method__sgsOuzel__createListener },
	{ "createScene", _sgs_method__sgsOuzel__createScene },
	{ "createLayer", _sgs_method__sgsOuzel__createLayer },
	{ "createActor", _sgs_method__sgsOuzel__createActor },
	...
	{ "createSound", _sgs_method__sgsOuzel__createSound },
	{ "createMixer", _sgs_method__sgsOuzel__createMixer },
